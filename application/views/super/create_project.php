...
<div id="main-content">
    <div class="container-fluid">
        ...
        <form method="post" action="<?= site_url('super/CreateProject')?>" >
            ...
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        <div class="form-group row">
                            <label class="col-md-4">No Applicant Required</label>
                            <div class="col-md-8">
                                <input type="number" name="applicant_required" class="form-control">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-4"></label>
                            <div class="col-md-8">
                                <button type="submit" class="btn btn-primary pull-right" style="width: 20%">Submit</button>
                            </div>
                        </div>
                    </div>
                </div>
