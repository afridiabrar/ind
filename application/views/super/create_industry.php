                                    ...
                                    <tr class="gradeA">
                                        ...
                                        <td class="actions">
                                            <button onclick="industry(<?= $v['id'] ?>)"
                                                  style="background: #0a6aa1"  class="btn btn-sm btn-icon btn-pure btn-default on-default m-r-5 button-edit">
                                                <i class="icon-pencil" aria-hidden="true"></i></button>
                                            <button class="btn btn-sm btn-icon btn-pure btn-default on-default button-remove"
                                                  style="background: red"  onclick="abv('<?= site_url('super/DeleteIndustry') ?>/<?=
                                            $v['id'] ?>')">
