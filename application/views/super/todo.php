<script>
    $(document).ready(function(){
        $("ul#main-menu > li > a > span:contains('Todo List')").parent().parent().addClass("active");
    });
</script>
<div id="main-content">
                ...
                <div class="card">
                    <div class="body">
                        <button class="btn btn-primary m-b-15" type="button" href="#defaultModal" data-toggle="modal" data-target="#defaultModal">
                            <i class="icon wb-plus" aria-hidden="true"></i> Add Todo List
                        </button>
                        <?php if(!empty($msg)){ ?>
                                ...
                                <?php foreach ($todo as $v){ ?>
                                    <tr class="gradeA">
                                        ...
                                        <td class="actions">
                                            ...
                                            <a href="<?= site_url('super/deletetoDo')?>/<?= $v['id'] ?>" class="btn btn-sm btn-icon btn-pure btn-primary on-default button-remove"><i class="icon-trash" aria-hidden="true"></i></a>
                                        </td>
                                    </tr>
                                <?php } ?>
                                </tbody>
...
<div class="modal fade" id="defaultModal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form method="post" action="<?= site_url('super/Todo')?>">
                <div class="modal-header">
                    <h4 class="title" id="largeModalLabel">Todo </h4>
                </div>
