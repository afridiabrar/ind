                                                ...
                                                <?php foreach ($seeker_data as $v) { ?>
                                                    <?php if ($v['verification_status'] == 'Step1') { ?>
                                                        ...
                                                        Available" ?>
                                                            ...
                                                            button-edit">
                                                                    <a href="<?= site_url('home/view/profile1') ?>/<?=
                                                                    $v['id'] ?>"
                                                            ...
                                                            button-edit" style="background: #0a6aa1">
                                                                ...
                                                                <button style="background: red" class="btn btn-sm btn-icon btn-pure btn-default on-default                                                                                          button-remove">
                                                                    <i class="icon-trash"
                                                                       aria-hidden="true"></i>
                                                                </button>
                                                            </td>
                                                    ...
                                                    <?php foreach ($seeker_data as $v) { ?>
                                                        ...
                                                        Available" ?>
                                                                ...
                                                                <td>
                                                                    <button style="background: #0a6aa1" class="btn btn-sm btn-icon btn-pure btn-default on-default m-r-5
                                                            button-edit">
                                                                        <a href="<?= site_url('home/view/profile1') ?>/<?= $v['id'] ?>"
                                                                        ><i class="icon-users"></i></a>
                                                                    </button>
                                                                    <button style="background: #0a6aa1" class="btn btn-sm btn-icon btn-pure btn-default on-default m-r-5
                                                            button-edit"
