                                ...
                                <?php foreach ($reminder as $v){ ?>
                                    <tr class="gradeA">
                                        ...
                                        <td class="actions">
                                            ...
                                            <a href="<?= site_url('home/deleteevent')?>/<?= $v['id'] ?>" class="btn btn-sm btn-icon btn-pure btn-primary on-default button-remove"><i class="icon-trash" aria-hidden="true"></i></a>
                                        </td>
                                    </tr>
                                <?php } ?>
                                </tbody>
...
<div class="modal fade" id="defaultModal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form method="post" action="<?= site_url('home/AddRemin')?>">
