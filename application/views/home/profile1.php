                    ...
                    <div class="body">
                        <div class="form-group">
                            ...
                            <div class="col-xs-6">
                                ...
                                <select name="verification_status" onchange="seeker()"
                                        class="form-control" style="background: #3b3e42;color:
                                         white">
                                    ...
                                    <option value="Step3"
                                        <?= $seeker_dataa[0]['verification_status'] == 'Step3' ? "selected" : "" ?>>Work
                                        Readiness
                                    </option>
                                    <option
                                            value="Step4"
                        ...
                        <div id="wizard_horizontal">
                            ...
                            <section style="width: 100%">
                                <form class="form"
                                      action="<?= site_url('home/AddInfo') ?>/<?= $seeker_dataa[0]['id'] ?>"
                            ...
                            <section style="width: 100%">
                                <form class="form"
                                      action="<?= site_url('home/InfoChange') ?>/<?= $seeker_dataa[0]['id'] ?>"
                                      method="post" id="registrationForm">
                                    ...
                                    <div class="inner-section">
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                <label for="first_name" class=""><h4>Industry</h4></label>
                                                <input style="width: 85%;float: right" type="text"
                                                       class="form-control" name="industry"
                                                       value="<?= (!empty($info_seeker[0]['industry'])) ?
                                                           $info_seeker[0]['industry'] : "" ?>">>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                <label for="first_name" class=""><h4>Title</h4></label>
                                                <input style="width: 85%;float: right" type="text"
                                                       class="form-control" name="job_title"
                                                       value="<?= (!empty($info_seeker[0]['job_title'])) ?
                                                           $info_seeker[0]['job_title'] : "" ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-xs-12">
                        ...
                        <section style="width: 100%">
                            <section>
                                <form method="post"
                                      action="<?= site_url('home/UpdatePol') ?>/<?= $seeker_dataa[0]['id'] ?>">
                                    <fieldset>
                                        <div class="form-group">
                                            <div class="col-xs-6">
                                                <label for="mobile"><h5>Police Verification</h5></label>
                                                <input name="police_check" style="width: 500px;float:
                                                right;display: block;position: absolute;top:25px;left: -17px"
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-6">
                                                <label for="mobile"><h5>Character Verification </h5></label>
                                                <input style="width: 500px;float:
                                                right;display: block;position: absolute;top:25px;left: -17px;margin-top: 53px"
                                                       name="police_char"
                                                       type="checkbox" class="form-control"
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-6">
                                                ...
                                                <textarea class="form-control" style="width: 85%;float: right"
                                                          name="police_note"
                                                          rows="7"><?= (!empty($info_seeker[0]['police_note'])) == '1' ? $info_seeker[0]['police_note']
                                                        : ""
                                                    ?></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-xs-6">
                                                <br>
                                                <button style="margin-top: 90px;position: absolute;right: 16px;width: 10%;background:
                                                    #3E4146"
                                                        class="btn btn-lg btn-success pull-right" type="submit"><i
                                                            class="icon-user"></i> Save
                                                </button>
                            ...
                            <div class="row" style="position: relative;top:71px;left: 15%">
                                <div class="col-xs-6">
                                    <select class="form-control" onchange="test()" style="width:500px;" name="testttt">
                                        <option>Please Select</option>
                                        <?php foreach ($interview as $v) { ?>
                                            <option value="<?= $v['id'] ?>"><?= $v['title'] ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                                <div class="col-xs-6">
                                    <button type="button" class="btn btn-primary" href="#defaultModal"
                                            data-toggle="modal"
                                            data-target="#defaultModal"
                                            style="width: 500px;margin-top: 2px;margin-right: 5px">And New Template
                                    </button>
...
<div class="modal fade" id="defaultModal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form method="post" action="<?= site_url('home/New_template/') . $seeker_dataa[0]['id'] ?>">
...
<script>
    function test() {
        ...
        $.post("<?= site_url('home/ModalInterview')?>", {id: id}, function (e) {
            $('.conf').html(e);
            $("#hello").modal();
    ...
    function seeker() {
        ...
        $.post("<?= site_url('home/changeStatus')?>", {status: status, id: id}, function (e) {
            location.reload();
        });
    }
</script>
