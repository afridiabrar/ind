                ...
                <div class="card">
                    <div class="body for-btn">
                        <div class="col-md-8 offset-md-1 btns">
                            <div class="row">
                                <div class="col-md-2">
                                    <div style="z-index: 999;position: absolute;bottom: 15px">
                                ...
                                <div class="col-md-3 btun2">
                                    <button type="button" onclick="templateModal()"
                                            style="position: absolute;z-index: 999;bottom: 5px;right: 125px;"
                                ...
                                <div class="col-md-3 btun2">
                                    <a style="position: absolute;z-index: 999;bottom: 5px;right: 157px;"
                                       href="<?= site_url('home/view/applicant') ?>">
                                            ...
                                            <?php if ($v['s_status'] == 'New_Applicant') { ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="<?= site_url('home/view/edit_applicant') ?>/<?= $v['id'] ?>">
                                                        ...
                                                        <button class="btn btn-sm btn-icon btn-pure btn-default on-default button-remove"
                                                                onclick="abvvvv('<?= site_url('home/DeleteSeeker') ?>/<?= $v['id']
                                                                ?>')">
                                                            <i class="icon-trash"
                                                               aria-hidden="true"></i>
                                                        </button>
...
<script>
    ...
    function templateModal() {
        ...
        if (chId != '') {
            $.post("<?= site_url('home/SendMail')?>", {id: chId}, function (e) {
                console.log(e);
                $('.conf').html(e);
                $("#modal").modal();
            });
