                        ...
                        <div class="col-md-8 offset-md-1 btns">
                            <div class="row">
                                <div class="col-md-2 btun2">
                                    <button style="position: absolute;z-index: 999;bottom: 5px;width: 100%;right: 115px"
                            ...
                            <table class="table table-bordered table-hover table-striped" id="myTable">
                                ...
                                <?php foreach ($campaign as $v) { ?>
                                    <?php if ($v['p_id'] == 0) { ?>
                                        <tr class="gradeA">
                                            <td><?= $v['p_title'] ?></td>
                                            <td><a href="<?= site_url('home/view/campaign') ?>/<?= $v['id'] ?>">
                                            ...
                                            <td class="actions">
                                                <a href="<?= site_url('home/view/single_campaign') ?>/<?= $v['id'] ?>">
                                                ...
                                                <button class="btn btn-sm btn-icon btn-pure btn-default on-default button-remove"
                                                        onclick="abv('<?= site_url('home/campaign/DeleteCampaign') ?>/<?= $v['id']
                                                        ?>')">
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form method="post" action="<?= site_url('home/campaign/CreateCampaign')?>">
...
<script>
    function campaign(id) {
        $.post("<?= site_url('home/Campaign_modal')?>",{id:id},function (e) {
            console.log(e);
            $('.conf').html(e);
            $('#modal').modal();
        });
