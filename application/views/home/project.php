                        ...
                        <div class="col-md-8 offset-md-1 btns">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2 btun2">
                                    <a style="position: absolute;z-index: 999;bottom: 5px"
                                       href="<?= site_url('home/view/create_project') ?>">
                                ...
                                <div class="col-md-2 btun2">
                                    <button style="width: 100%;position: absolute;z-index: 999;bottom: 5px;margin-left: 25px"
                                ...
                                <div class="col-md-2 btun2">
                                    <a href="<?= site_url('home/view/industry')?>">
                                        <button style="width: 100%;position: absolute;z-index: 999;bottom: 5px;margin-left: 39px"
                                                class="btn btn-primary m-b-15"
                                                type="button">
                                            View Industry
                                        </button>
                                ...
                                <?php foreach ($project as $v) { ?>
                                    <tr>
                                        ...
                                        <?php foreach ($v['seeker'] as $vv){ ?>
                                            <td>
                                                <a href="<?= site_url('home/view/applicant_request')?>?state=<?=
                                        ...
                                        <?php } ?>
                                        <td>
                                            <a href="<?= site_url('home/view/pipeline')?>/<?= $v['id'] ?>">
                                                <?= $v['confirm_applicant'] ?>
                                            </a>
                                        </td>
                                        <td><?= $v['status'] ?> </td>
                                        ...
                                        <a href="<?= site_url('home/view/edit_project')?>/<?= $v['id'] ?>">
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form method="post" action="<?= site_url('home/CreateIndusry')?>">
