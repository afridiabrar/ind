        ...
        <div class="vertical-align-middle auth-main">
            <div class="auth-box">
                <div class="mobile-logo"><a href="javascript:void(0)">
                        <img src="https://thememakker.com/templates/mplify/html/assets/images/logo-icon.svg" alt="Mplify"></a></div>
                <div class="auth-left">
                    <div class="left-top">
                ...
                <div class="auth-right">
                    <div class="card">
                        <div class="header">
                            <p class="lead">User Log in</p>
                        </div>
                        <?php if(!empty($msg)){ ?>
                            <span style="width: 100%" class="btn btn-danger"><?= $msg ?></span>
                        <?php } ?>
                        <div class="body">
                            <form class="form-auth-small" method="post" action="<?= site_url('home/do_login')?>">
