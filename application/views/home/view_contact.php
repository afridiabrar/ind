                        ...
                        <div class="col-md-8 offset-md-1 btns">
                            <div class="row">
                                <div class="col-md-2 btun2">
                                    <a style="position: absolute;z-index: 999;bottom: 5px;right: 119px;"
                                       href="<?= site_url('home/view/contacts') ?>">
                                    ...
                                    <tr class="gradeA">
                                        ...
                                        <td class="actions">
                                            ...
                                            <button class="btn btn-sm btn-icon btn-pure btn-default on-default button-remove"
                                                    onclick="abv('<?= site_url('home/') ?>/<?= $v['id']?>')"><i
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form method="post" action="<?= site_url('super/CreateAttender')?>">
